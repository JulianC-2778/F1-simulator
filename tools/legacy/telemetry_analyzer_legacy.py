#!/usr/bin/env python3
"""
Legacy Feature 2 implementation retained for reference only; not a production entrypoint.
"""
...
class MidwareBackedCollector:
    ...
    def start_background(self) -> None:
        if self._probe_mainline():
            ...
            print(
                f"[Collector] middleware unavailable at {self._midware_base_url}; "
                "waiting for the official backend (no UDP fallback)."
            )
